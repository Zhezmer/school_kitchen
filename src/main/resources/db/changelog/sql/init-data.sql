...
VALUES ((select id from role where role_name = 'ROLE_ADMIN'), 'root', '$2a$10$kifGdQNysdZJbSVHSnPFNOwWJtXsSz5Eys.oG.Ra8hE7WWBzGeNBW', 'админ', 'админ', 'admin@mail.ru', '33651', '05488');